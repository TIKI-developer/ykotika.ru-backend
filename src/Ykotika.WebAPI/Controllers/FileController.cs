...
namespace Ykotika.WebAPI.Controllers
{
    ...
    public class FileController : BaseController
    {
        ...
        {
            var command = new UploadFileCommand { FileData = ConvertToFileData(dto.File), RelativePath = dto.Path };
        ...
        {
            var command = new DeleteFileCommand { Path = Uri.UnescapeDataString(path) };
        ...
        {
            var command = new DownloadFileCommand { Path = Uri.UnescapeDataString(path) };
